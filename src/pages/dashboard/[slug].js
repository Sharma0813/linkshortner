        ...
        <div className=" xl:h-content 2xl:h-content w-content bg-white border rounded-2xl shadow-[0_12px_41px_-11px_rgba(199,199,199)]">
          <div className="xl:mx-3 xl:mt-2 2xl:mx-6 2xl:mt-5">
            <div className="flex justify-between xl:mt-3 2xl:mt-6">
              ...
              <button
                className="font-sans rounded-xl font-medium text-xs pl-3 pr-3 pt-0 pb-0 rounded-2xl bg-black text-white "
                ...
                <Fade in={openAddLink}>
                  <Box sx={styleLink} className="border-0">
                    ...
                    <div className="mt-5">
                      ...
                      <button
                        className="ml-80 font-medium mt-5 bg-purple-200 text-purple-700 border rounded-lg pt-1 pb-1 pr-2.5 pl-2.5 h-fit"
                        onClick={handleLinks}
                      >
                        Add Link
                      </button>
